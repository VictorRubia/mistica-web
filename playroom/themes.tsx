...
export const Telefonica_Empresas: ThemeConfig = {...themes.Telefonica_Empresas, ...common};
...
export const Telefonica_Empresas_iOS: ThemeConfig = {...Telefonica_Empresas, platformOverrides: {platform: 'ios'}};
