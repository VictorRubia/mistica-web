var e = "only screen and (min-height: 550px) and (min-width: 1024px) and (max-width: 1511px)", n = "only screen and (min-height: 550px) and (min-width: 1024px)", i = "only screen and (min-height: 550px) and (min-width: 1512px)", a = {
    tabletMinWidth: 768,
