...
import { useRifm as N } from "rifm";
import { useFieldProps as E } from "./form-context.js";
import { TextFieldBaseAutosuggest as L } from "./text-field-base.js";
...
import { formIbanError as F } from "./text-tokens.js";
const A = {
    ES: 24,
    GB: 22,
    DE: 22,
    ...
    const [m, u] = h.useState(n !== null && n !== void 0 ? n : ""), c = h.useRef(null), i = typeof e < "u", d = i ? e : m, g = h.useCallback((o)=>{
        i || u(o), c.current && (r == null || r(V(c.current, o)));
    }, [
        i,
        r
    ]), a = N({
    ...
    return /* @__PURE__ */ C("input", _object_spread_props(_object_spread({}, s), {
        maxLength: D(a.value),
        value: a.value,
        onChange: (o)=>{
            var f;
    ...
    const { texts: f, t: v } = k(), y = E({
        ...
        disabled: t,
        onBlur: g,
        validate: (p, x)=>Z(p !== null && p !== void 0 ? p : "") ? u == null ? void 0 : u(p, x) : f.formIbanError || v(F),
        validateOnBlurInsideForm: c,
        onChange: i,
        onChangeValue: d
    });
    return /* @__PURE__ */ C(L, _object_spread_props(_object_spread({}, l, y), {
        inputComponent: M,
