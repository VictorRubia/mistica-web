...
import { ImageContent as J, ImageError as O } from "./image.js";
...
const q = {
   ...
   */ loaded: {
    ...
    var { src: s, poster: u, autoPlay: g = "when-loaded", muted: S = !0, loop: k = !0, preload: x = "none", loadingTimeout: b = 1e4, onLoad: y, onError: h, onPause: w, onPlay: v, aspectRatio: c = 0, dataAttributes: U } = _param, n = _object_without_properties(_param, [
        "src",
        "poster",
        "autoPlay",
        "muted",
    ...
    const [l, o] = a.useReducer(D, "loading"), i = a.useRef(null), T = a.useRef(), f = a.useRef(null), p = n.width && n.height ? void 0 : typeof c == "number" ? c : K[c], R = a.useCallback(()=>{
    ...
    const C = ()=>{
        ...
        children: V.map((param, r)=>{
            ...
            return /* @__PURE__ */ d("source", {
                src: e,
                type: t
            }, r);
        })
    }), I = !!(p !== 0 || n.width && n.height), E = l === "error", B = a.useMemo(()=>u ? /* @__PURE__ */ d(J, {
            aspectRatio: c,
            width: n.width,
            height: n.height,
            src: u
