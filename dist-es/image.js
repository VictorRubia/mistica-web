...
import { SkeletonAnimation as V } from "./skeletons.js";
import { AspectRatioContainer as _ } from "./utils/aspect-ratio-support.js";
...
import { circularBorderRadius as j, withoutBorderRadius as D, withBorderRadius as $, defaultBorderRadius as K, FADE_IN_DURATION_MS as P, image as U, imageWithBorder as p } from "./image.css-mistica.js";
...
const Q = (param)=>{
    ...
    var I;
    const m = o.useId(), h = o.useRef(), u = i.circular ? j : l ? D : l === !1 ? $ : K, [y, f] = o.useState(!s), [N, g] = o.useState(!1), L = i.width && i.height ? void 0 : i.circular ? 1 : typeof e == "number" ? e : H[e], b = M && !!(L !== 0 || i.width && i.height), A = x && !!(L !== 0 || i.width && i.height), w = o.useCallback(()=>{
    ...
    o.useEffect(()=>{
        ...
        var R;
        (R = h.current) != null && R.complete && w();
    }, [
        w
    ]);
    const B = J() || !((I = document.getElementById(m)) != null && I.complete), W = /* @__PURE__ */ v(k, {
        children: [
            /* @__PURE__ */ t("img", {
            ...
            b && /* @__PURE__ */ t("script", {
                dangerouslySetInnerHTML: {
                    __html: `document.getElementById("${m}").addEventListener('load', (e) => e.target.style.opacity = "1")`
                }
            })
        ]
    });
...
export { Y as ImageContent, X as ImageError, H as RATIO, u1 as default };
