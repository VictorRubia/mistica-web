...
import { svg as a } from "./logo.css-mistica.js";
import { getBlauSkin as c } from "./skins/blau.js";
import { applyCssVars as e } from "./utils/css.js";
import { calcInlineVars as V } from "./logo-common.js";
const h = (param)=>{
    let { size: o, type: s, isDarkMode: i, isInverse: n, color: p } = param;
    const { colors: l } = c(), r = p || (n && !i ? l.inverse : l.brand), t = p || (n && !i ? l.inverse : l.promo);
    return s === "vertical" ? /* @__PURE__ */ C("svg", {
        className: a,
        style: e(V(o)),
        viewBox: "0 0 73 72",
        fill: r,
