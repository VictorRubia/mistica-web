...
import { container as R, containerWithWrapper as w, vars as N, wrapper as g } from "./aspect-ratio-support.css-mistica.js";
import { applyCssVars as y } from "./css.js";
const u = /*#__PURE__*/ o.createContext(!0), W = (param)=>{
    ...
    const n = !!t.forceNonCssAspectRatio, s = b() && !n, h = typeof t.width != "number" && typeof t.height != "number" && t.aspectRatio !== 0, a = h ? t.aspectRatio : void 0;
    ...
    const c = h && !s, r = /*#__PURE__*/ o.createElement((_t_as = t.as) !== null && _t_as !== void 0 ? _t_as : "div", _object_spread({
        ...
        style: _object_spread({}, c ? _object_spread_props(_object_spread({}, t.style), {
            ...
            [N.aspectRatio]: a ? String(a) : "unset"
        }))
