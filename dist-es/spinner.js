...
import { getPlatform as g } from "./utils/platform.js";
import N from "./fade-in.js";
import { useTheme as M } from "./hooks.js";
import { spinnerIos as u, spinnerIosSvgPath as r, spinnerDefault as L, spinnerDefaultPath as Z } from "./spinner.css-mistica.js";
import { vars as C } from "./skins/skin-contract.css-mistica.js";
import { useIsInverseOrMediaVariant as b } from "./theme-variant-context.js";
import { loading as x } from "./text-tokens.js";
...
const S = (param)=>{
    ...
    const { texts: h, platformOverrides: c, t: f } = M(), v = b();
    a = a || (v ? C.colors.controlActivatedInverse : C.colors.controlActivated);
    const t = d || h.loading || f(x), o = g(c) === "ios" ? /* @__PURE__ */ e("svg", {
        className: u,
        height: s,
    ...
    return i === "0" || i === "0s" || i === "0ms" ? o : /* @__PURE__ */ e(N, {
        delay: i,
        dataAttributes: {
