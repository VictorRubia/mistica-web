...
const V = (_param)=>{
    var { color: v, size: h = 24 } = _param, c = _object_without_properties(_param, [
        "color",
        "size"
    ]);
    const i = a(), o = v !== null && v !== void 0 ? v : i ? t.colors.inverse : t.colors.neutralHigh, { skinName: r } = n();
    return r.match(/^vivo-new/i) ? /* @__PURE__ */ e("svg", _object_spread_props(_object_spread({
        width: h,
        height: h,
        viewBox: "0 0 24 24",
        role: "presentation"
