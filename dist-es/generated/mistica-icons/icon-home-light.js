...
const s = (_param)=>{
    ...
    const r = n(), e = i !== null && i !== void 0 ? i : r ? o.colors.inverse : o.colors.neutralHigh, { skinName: t } = a();
    ...
    })) : t.match(/^o2-new/i) ? /* @__PURE__ */ c("svg", _object_spread_props(_object_spread({
        width: h,
        height: h,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : t.match(/^o2/i) ? /* @__PURE__ */ v("svg", _object_spread_props(_object_spread({
        width: h,
        height: h,
        viewBox: "0 0 24 24",
        role: "presentation"
