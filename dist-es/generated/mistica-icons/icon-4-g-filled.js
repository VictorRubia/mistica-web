...
const s = (_param)=>{
    ...
    const c = v(), e = r !== null && r !== void 0 ? r : c ? o.colors.inverse : o.colors.neutralHigh, { skinName: t } = n();
    return t.match(/^blau/i) ? /* @__PURE__ */ h("svg", _object_spread_props(_object_spread({
        width: a,
        height: a,
        viewBox: "0 0 24 24",
        role: "presentation"
