...
const f = (_param)=>{
    ...
    const s = n(), a = o !== null && o !== void 0 ? o : s ? r.colors.inverse : r.colors.neutralHigh, { skinName: e } = h();
    return e.match(/^blau/i) ? /* @__PURE__ */ t("svg", _object_spread_props(_object_spread({
        width: i,
        height: i,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : e.match(/^o2-new/i) ? /* @__PURE__ */ t("svg", _object_spread_props(_object_spread({
        width: i,
        height: i,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : e.match(/^o2/i) ? /* @__PURE__ */ t("svg", _object_spread_props(_object_spread({
        width: i,
        height: i,
        viewBox: "0 0 24 24",
        role: "presentation"
