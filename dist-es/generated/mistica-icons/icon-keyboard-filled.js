...
const l = (_param)=>{
    ...
    const r = n(), m = o !== null && o !== void 0 ? o : r ? e.colors.inverse : e.colors.neutralHigh, { skinName: t } = i();
    return t.match(/^o2-new/i) ? /* @__PURE__ */ s("svg", _object_spread_props(_object_spread({
        width: c,
        height: c,
        viewBox: "0 0 24 24",
        role: "presentation"
