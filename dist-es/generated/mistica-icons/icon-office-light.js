...
const l = (_param)=>{
    ...
    const i = m(), o = v !== null && v !== void 0 ? v : i ? t.colors.inverse : t.colors.neutralHigh, { skinName: n } = c();
    return n.match(/^o2-new/i) ? /* @__PURE__ */ s("svg", _object_spread_props(_object_spread({
        width: h,
        height: h,
        viewBox: "0 0 24 24",
        role: "presentation"
