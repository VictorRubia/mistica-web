...
const v = (_param)=>{
    ...
    const a = s(), t = h !== null && h !== void 0 ? h : a ? r.colors.inverse : r.colors.neutralHigh, { skinName: o } = n();
    return o.match(/^o2-new/i) ? /* @__PURE__ */ i("svg", _object_spread_props(_object_spread({
        width: c,
        height: c,
        viewBox: "0 0 24 24",
        role: "presentation"
