...
const s = (_param)=>{
    ...
    const t = a(), r = l !== null && l !== void 0 ? l : t ? e.colors.inverse : e.colors.neutralHigh, { skinName: i } = n();
    return i.match(/^o2-new/i) ? /* @__PURE__ */ h("svg", _object_spread_props(_object_spread({
        width: v,
        height: v,
        viewBox: "0 0 24 24",
        role: "presentation"
