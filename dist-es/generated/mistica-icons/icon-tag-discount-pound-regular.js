...
const s = (_param)=>{
    ...
    const n = i(), e = t !== null && t !== void 0 ? t : n ? r.colors.inverse : r.colors.neutralHigh, { skinName: h } = c();
    return h.match(/^o2-new/i) ? /* @__PURE__ */ o("svg", _object_spread_props(_object_spread({
        width: a,
        height: a,
        viewBox: "0 0 24 24",
        role: "presentation"
