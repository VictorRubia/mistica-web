...
const l = (_param)=>{
    ...
    const i = h(), r = t !== null && t !== void 0 ? t : i ? s.colors.inverse : s.colors.neutralHigh, { skinName: v } = n();
    return v.match(/^o2-new/i) ? /* @__PURE__ */ e("svg", _object_spread_props(_object_spread({
        width: c,
        height: c,
        viewBox: "0 0 24 24",
        role: "presentation"
