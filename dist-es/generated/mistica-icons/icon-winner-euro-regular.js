...
const m = (_param)=>{
    ...
    const i = s(), l = t !== null && t !== void 0 ? t : i ? o.colors.inverse : o.colors.neutralHigh, { skinName: n } = h();
    return n.match(/^o2-new/i) ? /* @__PURE__ */ e("svg", _object_spread_props(_object_spread({
        width: a,
        height: a,
        viewBox: "0 0 24 24",
        role: "presentation"
