...
const n = (_param)=>{
    ...
    const o = i(), e = r !== null && r !== void 0 ? r : o ? t.colors.inverse : t.colors.neutralHigh, { skinName: s } = a();
    return s.match(/^o2-new/i) ? /* @__PURE__ */ h("svg", _object_spread_props(_object_spread({
        width: c,
        height: c,
        viewBox: "0 0 24 24",
        role: "presentation"
