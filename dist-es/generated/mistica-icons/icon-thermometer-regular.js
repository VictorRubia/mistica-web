...
const v = (_param)=>{
    ...
    const l = h(), o = s !== null && s !== void 0 ? s : l ? i.colors.inverse : i.colors.neutralHigh, { skinName: a } = n();
    return a.match(/^vivo-new/i) ? /* @__PURE__ */ r("svg", _object_spread_props(_object_spread({
        width: e,
        height: e,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : a.match(/^o2-new/i) ? /* @__PURE__ */ c("svg", _object_spread_props(_object_spread({
        width: e,
        height: e,
        viewBox: "0 0 24 24",
        role: "presentation"
