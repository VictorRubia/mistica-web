...
const h = (_param)=>{
    ...
    const a = c(), t = i !== null && i !== void 0 ? i : a ? n.colors.inverse : n.colors.neutralHigh, { skinName: l } = s();
    return l.match(/^vivo-new/i) ? /* @__PURE__ */ e("svg", _object_spread_props(_object_spread({
        width: o,
        height: o,
        viewBox: "0 0 24 24",
        role: "presentation"
