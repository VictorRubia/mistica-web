...
const v = (_param)=>{
    ...
    const n = i(), r = t !== null && t !== void 0 ? t : n ? o.colors.inverse : o.colors.neutralHigh, { skinName: m } = a();
    return m.match(/^o2-new/i) ? /* @__PURE__ */ e("svg", _object_spread_props(_object_spread({
        width: c,
        height: c,
        viewBox: "0 0 24 24",
        role: "presentation"
