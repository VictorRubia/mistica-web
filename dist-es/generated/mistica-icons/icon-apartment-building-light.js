...
const n = (_param)=>{
    ...
    const c = a(), t = r !== null && r !== void 0 ? r : c ? i.colors.inverse : i.colors.neutralHigh, { skinName: e } = o();
    return e.match(/^o2-new/i) ? /* @__PURE__ */ v("svg", _object_spread_props(_object_spread({
        width: h,
        height: h,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : e.match(/^o2/i) ? /* @__PURE__ */ v("svg", _object_spread_props(_object_spread({
        width: h,
        height: h,
        viewBox: "0 0 24 24",
        role: "presentation"
