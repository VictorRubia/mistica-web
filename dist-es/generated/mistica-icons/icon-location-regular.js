...
const s = (_param)=>{
    ...
    const a = h(), t = n !== null && n !== void 0 ? n : a ? i.colors.inverse : i.colors.neutralHigh, { skinName: c } = l();
    return c.match(/^o2-new/i) ? /* @__PURE__ */ e("svg", _object_spread_props(_object_spread({
        width: o,
        height: o,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : c.match(/^o2/i) ? /* @__PURE__ */ e("svg", _object_spread_props(_object_spread({
        width: o,
        height: o,
        viewBox: "0 0 24 24",
        role: "presentation"
