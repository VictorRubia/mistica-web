...
const i = (_param)=>{
    ...
    const v = n(), a = o !== null && o !== void 0 ? o : v ? r.colors.inverse : r.colors.neutralHigh, { skinName: c } = t();
    return c.match(/^o2-new/i) ? /* @__PURE__ */ h("svg", _object_spread_props(_object_spread({
        width: l,
        height: l,
        viewBox: "0 0 24 24",
        role: "presentation"
