...
const m = (_param)=>{
    ...
    const n = a(), o = i !== null && i !== void 0 ? i : n ? r.colors.inverse : r.colors.neutralHigh, { skinName: s } = h();
    return s.match(/^o2-new/i) ? /* @__PURE__ */ l("svg", _object_spread_props(_object_spread({
        width: e,
        height: e,
        viewBox: "0 0 24 24",
        role: "presentation"
