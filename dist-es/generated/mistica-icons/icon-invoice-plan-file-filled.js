...
const m = (_param)=>{
    ...
    const h = s(), o = c !== null && c !== void 0 ? c : h ? r.colors.inverse : r.colors.neutralHigh, { skinName: a } = n();
    return a.match(/^o2-new/i) ? /* @__PURE__ */ t("svg", _object_spread_props(_object_spread({
        width: e,
        height: e,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : a.match(/^o2/i) ? /* @__PURE__ */ t("svg", _object_spread_props(_object_spread({
        width: e,
        height: e,
        viewBox: "0 0 24 24",
        role: "presentation"
