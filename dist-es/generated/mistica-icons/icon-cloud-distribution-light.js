...
const l = (_param)=>{
    ...
    const r = s(), o = e !== null && e !== void 0 ? e : r ? i.colors.inverse : i.colors.neutralHigh, { skinName: t } = a();
    return t.match(/^o2-new/i) ? /* @__PURE__ */ v("svg", _object_spread_props(_object_spread({
        width: c,
        height: c,
        viewBox: "0 0 24 24",
        role: "presentation"
