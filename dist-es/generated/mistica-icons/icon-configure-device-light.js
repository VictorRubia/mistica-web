...
const n = (_param)=>{
    ...
    const o = s(), a = i !== null && i !== void 0 ? i : o ? e.colors.inverse : e.colors.neutralHigh, { skinName: v } = t();
    return v.match(/^o2-new/i) ? /* @__PURE__ */ l("svg", _object_spread_props(_object_spread({
        width: c,
        height: c,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : v.match(/^o2/i) ? /* @__PURE__ */ l("svg", _object_spread_props(_object_spread({
        width: c,
        height: c,
        viewBox: "0 0 24 24",
        role: "presentation"
