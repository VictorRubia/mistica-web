...
const l = (_param)=>{
    ...
    const r = i(), o = e !== null && e !== void 0 ? e : r ? t.colors.inverse : t.colors.neutralHigh, { skinName: m } = s();
    return m.match(/^o2-new/i) ? /* @__PURE__ */ a("svg", _object_spread_props(_object_spread({
        width: c,
        height: c,
        viewBox: "0 0 24 24",
        role: "presentation"
