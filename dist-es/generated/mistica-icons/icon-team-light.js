...
const n = (_param)=>{
    ...
    const h = r(), a = t !== null && t !== void 0 ? t : h ? e.colors.inverse : e.colors.neutralHigh, { skinName: v } = i();
    return v.match(/^o2-new/i) ? /* @__PURE__ */ o("svg", _object_spread_props(_object_spread({
        width: l,
        height: l,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : v.match(/^o2/i) ? /* @__PURE__ */ c("svg", _object_spread_props(_object_spread({
        width: l,
        height: l,
        viewBox: "0 0 24 24",
        role: "presentation"
