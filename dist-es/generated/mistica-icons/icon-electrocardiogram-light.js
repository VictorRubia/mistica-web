...
const s = (_param)=>{
    ...
    const t = n(), r = e !== null && e !== void 0 ? e : t ? o.colors.inverse : o.colors.neutralHigh, { skinName: l } = i();
    return l.match(/^o2-new/i) ? /* @__PURE__ */ h("svg", _object_spread_props(_object_spread({
        width: c,
        height: c,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : l.match(/^o2/i) ? /* @__PURE__ */ h("svg", _object_spread_props(_object_spread({
        width: c,
        height: c,
        viewBox: "0 0 24 24",
        role: "presentation"
