...
const m = (_param)=>{
    ...
    const a = i(), h = t !== null && t !== void 0 ? t : a ? e.colors.inverse : e.colors.neutralHigh, { skinName: o } = r();
    return o.match(/^o2-new/i) ? /* @__PURE__ */ v("svg", _object_spread_props(_object_spread({
        width: c,
        height: c,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : o.match(/^o2/i) ? /* @__PURE__ */ v("svg", _object_spread_props(_object_spread({
        width: c,
        height: c,
        viewBox: "0 0 24 24",
        role: "presentation"
