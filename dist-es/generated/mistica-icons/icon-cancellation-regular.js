...
const v = (_param)=>{
    ...
    const i = m(), l = h !== null && h !== void 0 ? h : i ? t.colors.inverse : t.colors.neutralHigh, { skinName: n } = s();
    return n.match(/^o2-new/i) ? /* @__PURE__ */ r("svg", _object_spread_props(_object_spread({
        width: a,
        height: a,
        viewBox: "0 0 24 24",
        role: "presentation"
