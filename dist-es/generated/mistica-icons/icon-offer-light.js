...
const s = (_param)=>{
    ...
    const i = n(), e = t !== null && t !== void 0 ? t : i ? o.colors.inverse : o.colors.neutralHigh, { skinName: r } = h();
    return r.match(/^o2-new/i) ? /* @__PURE__ */ c("svg", _object_spread_props(_object_spread({
        width: l,
        height: l,
        viewBox: "0 0 24 24",
        role: "presentation"
