...
const m = (_param)=>{
    ...
    const s = h(), l = t !== null && t !== void 0 ? t : s ? o.colors.inverse : o.colors.neutralHigh, { skinName: i } = n();
    return i.match(/^o2-new/i) ? /* @__PURE__ */ r("svg", _object_spread_props(_object_spread({
        width: c,
        height: c,
        viewBox: "0 0 24 24",
        role: "presentation"
