...
const n = (_param)=>{
    ...
    const r = s(), a = t !== null && t !== void 0 ? t : r ? i.colors.inverse : i.colors.neutralHigh, { skinName: e } = m();
    return e.match(/^o2-new/i) ? /* @__PURE__ */ o("svg", _object_spread_props(_object_spread({
        width: c,
        height: c,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : e.match(/^o2/i) ? /* @__PURE__ */ o("svg", _object_spread_props(_object_spread({
        width: c,
        height: c,
        viewBox: "0 0 24 24",
        role: "presentation"
