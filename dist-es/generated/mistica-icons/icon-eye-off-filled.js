...
const m = (_param)=>{
    ...
    const n = s(), e = r !== null && r !== void 0 ? r : n ? i.colors.inverse : i.colors.neutralHigh, { skinName: o } = h();
    return o.match(/^o2-new/i) ? /* @__PURE__ */ t("svg", _object_spread_props(_object_spread({
        width: a,
        height: a,
        viewBox: "0 0 24 24",
        role: "presentation"
