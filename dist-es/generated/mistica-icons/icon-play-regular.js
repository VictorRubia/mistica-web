...
const s = (_param)=>{
    ...
    const i = h(), o = a !== null && a !== void 0 ? a : i ? t.colors.inverse : t.colors.neutralHigh, { skinName: c } = n();
    return c.match(/^o2-new/i) ? /* @__PURE__ */ r("svg", _object_spread_props(_object_spread({
        width: e,
        height: e,
        viewBox: "0 0 24 24",
        role: "presentation"
