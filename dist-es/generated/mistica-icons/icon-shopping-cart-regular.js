...
const m = (_param)=>{
    ...
    const h = n(), l = o !== null && o !== void 0 ? o : h ? t.colors.inverse : t.colors.neutralHigh, { skinName: r } = i();
    return r.match(/^blau/i) ? /* @__PURE__ */ a("svg", _object_spread_props(_object_spread({
        width: c,
        height: c,
        viewBox: "0 0 24 24",
        role: "presentation"
