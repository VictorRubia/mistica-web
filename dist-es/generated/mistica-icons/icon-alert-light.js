...
const m = (_param)=>{
    ...
    const h = s(), a = c !== null && c !== void 0 ? c : h ? o.colors.inverse : o.colors.neutralHigh, { skinName: l } = n();
    return l.match(/^vivo-new/i) ? /* @__PURE__ */ r("svg", _object_spread_props(_object_spread({
        width: e,
        height: e,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : l.match(/^o2-new/i) ? /* @__PURE__ */ t("svg", _object_spread_props(_object_spread({
        width: e,
        height: e,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : l.match(/^o2/i) ? /* @__PURE__ */ t("svg", _object_spread_props(_object_spread({
        width: e,
        height: e,
        viewBox: "0 0 24 24",
        role: "presentation"
