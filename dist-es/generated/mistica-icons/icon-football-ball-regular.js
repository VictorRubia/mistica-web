...
const h = (_param)=>{
    ...
    const t = n(), m = r !== null && r !== void 0 ? r : t ? e.colors.inverse : e.colors.neutralHigh, { skinName: o } = i();
    return o.match(/^o2-new/i) ? /* @__PURE__ */ c("svg", _object_spread_props(_object_spread({
        width: l,
        height: l,
        viewBox: "0 0 24 24",
        role: "presentation"
