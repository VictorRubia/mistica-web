...
const n = (_param)=>{
    ...
    const o = r(), l = e !== null && e !== void 0 ? e : o ? t.colors.inverse : t.colors.neutralHigh, { skinName: m } = i();
    return m.match(/^o2-new/i) ? /* @__PURE__ */ c("svg", _object_spread_props(_object_spread({
        width: a,
        height: a,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : m.match(/^o2/i) ? /* @__PURE__ */ c("svg", _object_spread_props(_object_spread({
        width: a,
        height: a,
        viewBox: "0 0 24 24",
        role: "presentation"
