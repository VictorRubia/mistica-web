...
const h = (_param)=>{
    ...
    const i = s(), l = a !== null && a !== void 0 ? a : i ? t.colors.inverse : t.colors.neutralHigh, { skinName: n } = c();
    return n.match(/^blau/i) ? /* @__PURE__ */ e("svg", _object_spread_props(_object_spread({
        width: r,
        height: r,
        viewBox: "0 0 24 24",
        role: "presentation"
