...
const m = (_param)=>{
    ...
    const i = h(), e = o !== null && o !== void 0 ? o : i ? t.colors.inverse : t.colors.neutralHigh, { skinName: r } = n();
    return r.match(/^blau/i) ? /* @__PURE__ */ l("svg", _object_spread_props(_object_spread({
        width: a,
        height: a,
        viewBox: "0 0 24 24",
        role: "presentation"
