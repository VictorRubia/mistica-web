...
const m = (_param)=>{
    ...
    const n = s(), r = l !== null && l !== void 0 ? l : n ? i.colors.inverse : i.colors.neutralHigh, { skinName: o } = h();
    return o.match(/^vivo-new/i) ? /* @__PURE__ */ c("svg", _object_spread_props(_object_spread({
        width: e,
        height: e,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : o.match(/^o2-new/i) ? /* @__PURE__ */ a("svg", _object_spread_props(_object_spread({
        width: e,
        height: e,
        viewBox: "0 0 24 24",
        role: "presentation"
