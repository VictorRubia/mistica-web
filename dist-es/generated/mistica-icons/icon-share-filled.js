...
const s = (_param)=>{
    ...
    const a = n(), r = t !== null && t !== void 0 ? t : a ? o.colors.inverse : o.colors.neutralHigh, { skinName: i } = h();
    return i.match(/^vivo-new/i) ? /* @__PURE__ */ l("svg", _object_spread_props(_object_spread({
        width: e,
        height: e,
        viewBox: "0 0 24 24",
        role: "presentation"
