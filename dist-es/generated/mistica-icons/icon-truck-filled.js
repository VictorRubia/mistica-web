...
const s = (_param)=>{
    ...
    const c = v(), h = a !== null && a !== void 0 ? a : c ? l.colors.inverse : l.colors.neutralHigh, { skinName: t } = n();
    return t.match(/^o2-new/i) ? /* @__PURE__ */ i("svg", _object_spread_props(_object_spread({
        width: e,
        height: e,
        viewBox: "0 0 24 24",
        role: "presentation"
