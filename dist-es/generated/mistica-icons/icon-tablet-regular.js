...
const v = (_param)=>{
    ...
    const i = n(), r = l !== null && l !== void 0 ? l : i ? o.colors.inverse : o.colors.neutralHigh, { skinName: c } = a();
    return c.match(/^blau/i) ? /* @__PURE__ */ h("svg", _object_spread_props(_object_spread({
        width: e,
        height: e,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : c.match(/^o2-new/i) ? /* @__PURE__ */ h("svg", _object_spread_props(_object_spread({
        width: e,
        height: e,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : c.match(/^o2/i) ? /* @__PURE__ */ h("svg", _object_spread_props(_object_spread({
        width: e,
        height: e,
        viewBox: "0 0 24 24",
        role: "presentation"
