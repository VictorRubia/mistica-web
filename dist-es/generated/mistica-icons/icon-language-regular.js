...
const s = (_param)=>{
    ...
    const t = n(), c = l !== null && l !== void 0 ? l : t ? o.colors.inverse : o.colors.neutralHigh, { skinName: h } = i();
    return h.match(/^o2-new/i) ? /* @__PURE__ */ m("svg", _object_spread_props(_object_spread({
        width: a,
        height: a,
        viewBox: "0 0 24 24",
        role: "presentation"
