...
const n = (_param)=>{
    ...
    const i = o(), h = r !== null && r !== void 0 ? r : i ? t.colors.inverse : t.colors.neutralHigh, { skinName: e } = m();
    return e.match(/^vivo-new/i) ? /* @__PURE__ */ c("svg", _object_spread_props(_object_spread({
        width: a,
        height: a,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : e.match(/^o2-new/i) ? /* @__PURE__ */ c("svg", _object_spread_props(_object_spread({
        width: a,
        height: a,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : e.match(/^o2/i) ? /* @__PURE__ */ c("svg", _object_spread_props(_object_spread({
        width: a,
        height: a,
        viewBox: "0 0 24 24",
        role: "presentation"
