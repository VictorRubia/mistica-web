...
const v = (_param)=>{
    ...
    const a = n(), h = t !== null && t !== void 0 ? t : a ? o.colors.inverse : o.colors.neutralHigh, { skinName: c } = i();
    return c.match(/^blau/i) ? /* @__PURE__ */ e("svg", _object_spread_props(_object_spread({
        width: l,
        height: l,
        viewBox: "0 0 24 24",
        role: "presentation"
