...
const v = (_param)=>{
    ...
    const s = n(), a = r !== null && r !== void 0 ? r : s ? o.colors.inverse : o.colors.neutralHigh, { skinName: i } = h();
    return i.match(/^o2-new/i) ? /* @__PURE__ */ t("svg", _object_spread_props(_object_spread({
        width: l,
        height: l,
        viewBox: "0 0 24 24",
        role: "presentation"
