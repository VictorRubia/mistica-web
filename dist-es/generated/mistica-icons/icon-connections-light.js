...
import { useIsInverseOrMediaVariant as r } from "../../theme-variant-context.js";
...
const h = (_param)=>{
    ...
    const m = r(), l = i !== null && i !== void 0 ? i : m ? t.colors.inverse : t.colors.neutralHigh, { skinName: e } = n();
    ...
    })) : e.match(/^o2/i) ? /* @__PURE__ */ s("svg", _object_spread_props(_object_spread({
        width: a,
        height: a,
        viewBox: "0 0 24 24",
        role: "presentation"
