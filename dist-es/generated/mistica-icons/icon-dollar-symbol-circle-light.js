...
const h = (_param)=>{
    ...
    const t = v(), l = s !== null && s !== void 0 ? s : t ? i.colors.inverse : i.colors.neutralHigh, { skinName: a } = n();
    return a.match(/^vivo-new/i) ? /* @__PURE__ */ e("svg", _object_spread_props(_object_spread({
        width: c,
        height: c,
        viewBox: "0 0 24 24",
        role: "presentation"
