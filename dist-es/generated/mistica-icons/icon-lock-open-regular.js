...
const s = (_param)=>{
    ...
    const i = a(), h = l !== null && l !== void 0 ? l : i ? t.colors.inverse : t.colors.neutralHigh, { skinName: r } = v();
    return r.match(/^blau/i) ? /* @__PURE__ */ n("svg", _object_spread_props(_object_spread({
        width: c,
        height: c,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : r.match(/^o2/i) ? /* @__PURE__ */ e("svg", _object_spread_props(_object_spread({
        width: c,
        height: c,
        viewBox: "0 0 24 24",
        role: "presentation"
