...
const c = (_param)=>{
    ...
    const n = s(), h = i !== null && i !== void 0 ? i : n ? t.colors.inverse : t.colors.neutralHigh, { skinName: v } = l();
    return v.match(/^o2-new/i) ? /* @__PURE__ */ r("svg", _object_spread_props(_object_spread({
        width: e,
        height: e,
        viewBox: "0 0 24 24",
        role: "presentation"
