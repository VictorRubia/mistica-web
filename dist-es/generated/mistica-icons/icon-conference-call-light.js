...
const i = (_param)=>{
    ...
    const m = n(), o = r !== null && r !== void 0 ? r : m ? s.colors.inverse : s.colors.neutralHigh, { skinName: h } = t();
    return h.match(/^o2-new/i) ? /* @__PURE__ */ c("svg", _object_spread_props(_object_spread({
        width: a,
        height: a,
        viewBox: "0 0 24 24",
        role: "presentation"
