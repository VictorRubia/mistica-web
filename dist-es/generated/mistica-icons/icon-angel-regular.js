...
const h = (_param)=>{
    ...
    const n = l(), o = t !== null && t !== void 0 ? t : n ? a.colors.inverse : a.colors.neutralHigh, { skinName: s } = i();
    return s.match(/^o2-new/i) ? /* @__PURE__ */ c("svg", _object_spread_props(_object_spread({
        width: e,
        height: e,
        viewBox: "0 0 24 24",
        role: "presentation"
