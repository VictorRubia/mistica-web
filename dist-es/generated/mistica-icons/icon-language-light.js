...
const s = (_param)=>{
    ...
    const t = n(), e = r !== null && r !== void 0 ? r : t ? o.colors.inverse : o.colors.neutralHigh, { skinName: h } = l();
    return h.match(/^o2-new/i) ? /* @__PURE__ */ i("svg", _object_spread_props(_object_spread({
        width: a,
        height: a,
        viewBox: "0 0 24 24",
        role: "presentation"
