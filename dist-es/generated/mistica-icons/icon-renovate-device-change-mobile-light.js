...
const m = (_param)=>{
    ...
    const i = v(), h = t !== null && t !== void 0 ? t : i ? o.colors.inverse : o.colors.neutralHigh, { skinName: l } = n();
    return l.match(/^o2-new/i) ? /* @__PURE__ */ c("svg", _object_spread_props(_object_spread({
        width: e,
        height: e,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : l.match(/^o2/i) ? /* @__PURE__ */ c("svg", _object_spread_props(_object_spread({
        width: e,
        height: e,
        viewBox: "0 0 24 24",
        role: "presentation"
