...
const v = (_param)=>{
    ...
    const r = m(), l = i !== null && i !== void 0 ? i : r ? t.colors.inverse : t.colors.neutralHigh, { skinName: e } = n();
    return e.match(/^blau/i) ? /* @__PURE__ */ o("svg", _object_spread_props(_object_spread({
        width: a,
        height: a,
        viewBox: "0 0 24 24",
        role: "presentation"
