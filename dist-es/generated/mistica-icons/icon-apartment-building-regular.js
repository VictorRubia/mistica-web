...
const i = (_param)=>{
    ...
    const o = c(), e = t !== null && t !== void 0 ? t : o ? r.colors.inverse : r.colors.neutralHigh, { skinName: V } = a();
    return V.match(/^o2-new/i) ? /* @__PURE__ */ m("svg", _object_spread_props(_object_spread({
        width: h,
        height: h,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : V.match(/^o2/i) ? /* @__PURE__ */ m("svg", _object_spread_props(_object_spread({
        width: h,
        height: h,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : /* @__PURE__ */ m("svg", _object_spread_props(_object_spread({
        width: h,
        height: h,
        viewBox: "0 0 24 24",
        role: "presentation"
