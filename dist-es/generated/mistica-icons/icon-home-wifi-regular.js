...
const m = (_param)=>{
    ...
    const i = s(), e = r !== null && r !== void 0 ? r : i ? l.colors.inverse : l.colors.neutralHigh, { skinName: h } = n();
    return h.match(/^vivo-new/i) ? /* @__PURE__ */ t("svg", _object_spread_props(_object_spread({
        width: c,
        height: c,
        viewBox: "0 0 24 24",
        role: "presentation"
