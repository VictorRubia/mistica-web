...
const v = (_param)=>{
    ...
    const r = s(), e = l !== null && l !== void 0 ? l : r ? c.colors.inverse : c.colors.neutralHigh, { skinName: a } = n();
    return a.match(/^o2-new/i) ? /* @__PURE__ */ o("svg", _object_spread_props(_object_spread({
        width: h,
        height: h,
        viewBox: "0 0 24 24",
        role: "presentation"
