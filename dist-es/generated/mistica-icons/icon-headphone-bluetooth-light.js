...
const v = (_param)=>{
    ...
    const s = n(), h = i !== null && i !== void 0 ? i : s ? l.colors.inverse : l.colors.neutralHigh, { skinName: r } = a();
    return r.match(/^o2-new/i) ? /* @__PURE__ */ e("svg", _object_spread_props(_object_spread({
        width: o,
        height: o,
        viewBox: "0 0 24 24",
        role: "presentation"
