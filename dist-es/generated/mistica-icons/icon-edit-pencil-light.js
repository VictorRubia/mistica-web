...
const h = (_param)=>{
    ...
    const r = s(), t = l !== null && l !== void 0 ? l : r ? c.colors.inverse : c.colors.neutralHigh, { skinName: a } = n();
    return a.match(/^vivo-new/i) ? /* @__PURE__ */ i("svg", _object_spread_props(_object_spread({
        width: e,
        height: e,
        viewBox: "0 0 24 24",
        role: "presentation"
