...
const v = (_param)=>{
    ...
    const s = n(), e = i !== null && i !== void 0 ? i : s ? o.colors.inverse : o.colors.neutralHigh, { skinName: r } = t();
    return r.match(/^o2-new/i) ? /* @__PURE__ */ a("svg", _object_spread_props(_object_spread({
        width: c,
        height: c,
        viewBox: "0 0 24 24",
        role: "presentation"
