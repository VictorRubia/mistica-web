...
const n = (_param)=>{
    ...
    const h = s(), i = v !== null && v !== void 0 ? v : h ? r.colors.inverse : r.colors.neutralHigh, { skinName: t } = l();
    return t.match(/^o2-new/i) ? /* @__PURE__ */ o("svg", _object_spread_props(_object_spread({
        width: c,
        height: c,
        viewBox: "0 0 24 24",
        role: "presentation"
