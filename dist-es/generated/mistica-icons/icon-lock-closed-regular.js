...
const s = (_param)=>{
    ...
    const i = n(), e = r !== null && r !== void 0 ? r : i ? t.colors.inverse : t.colors.neutralHigh, { skinName: a } = v();
    ...
    })) : a.match(/^o2-new/i) ? /* @__PURE__ */ o("svg", _object_spread_props(_object_spread({
        width: h,
        height: h,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : a.match(/^o2/i) ? /* @__PURE__ */ o("svg", _object_spread_props(_object_spread({
        width: h,
        height: h,
        viewBox: "0 0 24 24",
        role: "presentation"
