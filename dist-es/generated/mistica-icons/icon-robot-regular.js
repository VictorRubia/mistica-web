...
const m = (_param)=>{
    ...
    const r = i(), l = e !== null && e !== void 0 ? e : r ? o.colors.inverse : o.colors.neutralHigh, { skinName: a } = t();
    return a.match(/^o2-new/i) ? /* @__PURE__ */ v("svg", _object_spread_props(_object_spread({
        width: c,
        height: c,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : a.match(/^o2/i) ? /* @__PURE__ */ v("svg", _object_spread_props(_object_spread({
        width: c,
        height: c,
        viewBox: "0 0 24 24",
        role: "presentation"
