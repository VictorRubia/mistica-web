...
const v = (_param)=>{
    var { color: c, size: l = 24 } = _param, h = _object_without_properties(_param, [
        "color",
        "size"
    ]);
    const i = n(), r = c !== null && c !== void 0 ? c : i ? t.colors.inverse : t.colors.neutralHigh, { skinName: o } = a();
    return o.match(/^blau/i) ? /* @__PURE__ */ e("svg", _object_spread_props(_object_spread({
        width: l,
        height: l,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : o.match(/^o2-new/i) ? /* @__PURE__ */ e("svg", _object_spread_props(_object_spread({
        width: l,
        height: l,
        viewBox: "0 0 24 24",
        role: "presentation"
