...
const s = (_param)=>{
    ...
    const c = v(), a = r !== null && r !== void 0 ? r : c ? t.colors.inverse : t.colors.neutralHigh, { skinName: o } = n();
    return o.match(/^blau/i) ? /* @__PURE__ */ l("svg", _object_spread_props(_object_spread({
        width: e,
        height: e,
        viewBox: "0 0 24 24",
        role: "presentation"
