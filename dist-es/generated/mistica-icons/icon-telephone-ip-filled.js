...
const v = (_param)=>{
    ...
    const n = a(), h = t !== null && t !== void 0 ? t : n ? i.colors.inverse : i.colors.neutralHigh, { skinName: r } = l();
    return r.match(/^vivo-new/i) ? /* @__PURE__ */ o("svg", _object_spread_props(_object_spread({
        width: e,
        height: e,
        viewBox: "0 0 24 24",
        role: "presentation"
