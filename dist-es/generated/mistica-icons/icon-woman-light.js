...
const s = (_param)=>{
    ...
    const r = n(), o = t !== null && t !== void 0 ? t : r ? e.colors.inverse : e.colors.neutralHigh, { skinName: c } = i();
    return c.match(/^o2-new/i) ? /* @__PURE__ */ a("svg", _object_spread_props(_object_spread({
        width: l,
        height: l,
        viewBox: "0 0 24 24",
        role: "presentation"
