...
const d = (_param)=>{
    ...
    const h = c(), l = a !== null && a !== void 0 ? a : h ? r.colors.inverse : r.colors.neutralHigh, { skinName: n } = s();
    return n.match(/^o2-new/i) ? /* @__PURE__ */ i("svg", _object_spread_props(_object_spread({
        width: t,
        height: t,
        viewBox: "0 0 24 24",
        role: "presentation"
