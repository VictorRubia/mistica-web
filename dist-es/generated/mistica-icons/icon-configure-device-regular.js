...
const m = (_param)=>{
    ...
    const o = n(), a = r !== null && r !== void 0 ? r : o ? e.colors.inverse : e.colors.neutralHigh, { skinName: v } = t();
    return v.match(/^o2-new/i) ? /* @__PURE__ */ c("svg", _object_spread_props(_object_spread({
        width: l,
        height: l,
        viewBox: "0 0 24 24",
        role: "presentation"
