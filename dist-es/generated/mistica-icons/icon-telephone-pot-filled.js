...
const m = (_param)=>{
    ...
    const i = v(), e = r !== null && r !== void 0 ? r : i ? t.colors.inverse : t.colors.neutralHigh, { skinName: l } = n();
    return l.match(/^o2-new/i) ? /* @__PURE__ */ s("svg", _object_spread_props(_object_spread({
        width: c,
        height: c,
        viewBox: "0 0 24 24",
        role: "presentation"
