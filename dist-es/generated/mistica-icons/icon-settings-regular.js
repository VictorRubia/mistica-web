...
const s = (_param)=>{
    ...
    const i = n(), l = r !== null && r !== void 0 ? r : i ? v.colors.inverse : v.colors.neutralHigh, { skinName: t } = o();
    return t.match(/^o2-new/i) ? /* @__PURE__ */ e("svg", _object_spread_props(_object_spread({
        width: a,
        height: a,
        viewBox: "0 0 24 24",
        role: "presentation"
