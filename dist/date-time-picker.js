...
const K = {
    ...
    const [m, y] = _react.useState(!1), { texts: x, i18n: { locale: b }, t: k } = (0, _hooks.useTheme)(), r = _react.useRef(null), { height: C, ref: v } = (0, _hooks.useElementDimensions)(), l = (e)=>{
        o.disabled || y(e);
    }, D = ()=>{
        var f;
        ...
        r.current && (r.current.focus(), (c = o.onChange) == null || c.call(o, (0, _dom.createChangeEvent)(r.current, t)));
    }, M = ()=>s() && u ? /* @__PURE__ */ (0, _jsxruntime.jsx)(_textfieldbase.FieldEndIcon, {
            Icon: _iconcloseregular.default,
            "aria-label": x.clearButton || k(_texttokens.clearButton),
