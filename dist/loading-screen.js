...
const J = (param)=>{
...
}, R = /*#__PURE__*/ _react.forwardRef((param, f)=>{
    ...
    const b = _react.useRef(!1), g = _react.useCallback(()=>{
    ...
    return (0, _overscrollcolorcontext.useSetOverscrollColor)(e ? {
        ...
        children: [
            ...
            t && d && /* @__PURE__ */ (0, _jsxruntime.jsx)(J, {
                isInverse: !!e
            })
        ]
    });
}), he = /*#__PURE__*/ _react.forwardRef((e, r)=>/* @__PURE__ */ (0, _jsxruntime.jsx)(R, _object_spread_props(_object_spread({
        ref: r
    }, e), {
    ...
    return /* @__PURE__ */ (0, _jsxruntime.jsxs)("div", {
        className: (0, _classnames.default)(_loadingscreencssmistica.logo, {
            [_loadingscreencssmistica.pulseLogo]: s
        }),
        onAnimationIteration: u,
        children: [
            /* @__PURE__ */ (0, _jsxruntime.jsx)(_screenreaderonly.default, {
                children: /* @__PURE__ */ (0, _jsxruntime.jsx)("div", {
                    children: i.loading || c(_texttokens.loading)
                })
            }),
    ...
    const { themeVariants: s } = (0, _hooks.useTheme)(), [a, u] = _react.useState(!1), l = _react.useRef(!1), m = _react.useRef(!1), f = ()=>{
        u(!0);
    }, d = ()=>{
