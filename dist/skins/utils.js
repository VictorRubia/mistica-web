...
const _telefonicaempresas = require("./telefonica-empresas.js");
...
const _esimflag = require("./esimflag.js");
...
const C = (r, o)=>{
    switch(r){
        ...
        case _constants.TELEFONICA_EMPRESAS_SKIN:
            return (0, _telefonicaempresas.getTelefonicaEmpresasSkin)();
        ...
        case _constants.ESIMFLAG_SKIN:
            return (0, _esimflag.getEsimflagSkin)();
        default:
            throw Error("Unknown skin name: " + r);
    }
}, l = (r)=>_react.Children.toArray(r).reduce((e, t)=>t.type === _react.Fragment ? e.concat(l(t.props.children)) : (e.push(t), e), []);
