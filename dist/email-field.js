...
const j = /^[^\s@]+@[^\s@]+\.[^\s@]+$/, y = (_param)=>{
    ...
    const { texts: x, t: A } = (0, _hooks.useTheme)(), g = (0, _formcontext.useFieldProps)({
        name: i,
        label: m,
        value: d,
        defaultValue: E,
        ...
        disabled: r,
        onBlur: c,
        validate: (t, M)=>j.test(t !== null && t !== void 0 ? t : "") ? e == null ? void 0 : e(t, M) : x.formEmailError || A(_texttokens.formEmailError),
        validateOnBlurInsideForm: a,
        onChange: n,
        onChangeValue: u
    });
    return /* @__PURE__ */ (0, _jsxruntime.jsx)(_textfieldbase.TextFieldBaseAutosuggest, _object_spread_props(_object_spread({}, F, g), {
        type: "email",
        inputMode: "email",
        autoComplete: f,
