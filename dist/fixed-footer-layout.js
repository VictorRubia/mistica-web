...
const ie = (e)=>e === document.documentElement ? window : e, ne = (e)=>{
    ...
    const [$, h] = _react.useState(!1), d = _react.useRef(null), { height: m } = (0, _hooks.useBoundingRect)(d) || {
        height: 0
    }, { isTabletOrSmaller: u } = (0, _hooks.useScreenSize)(), { platformOverrides: v } = (0, _hooks.useTheme)(), { height: o, ref: N } = (0, _hooks.useElementDimensions)({
        includeMargins: !0
    }), { visualHeight: w } = (0, _hooks.useWindowSize)(), a = (0, _fixedtotop.useFixedToTopHeight)(), t = w - a - o > ce, { topColor: D = i } = (0, _overscrollcolorcontext.useOverScrollColor)(), { height: x, ref: I } = (0, _hooks.useElementDimensions)();
    (0, _hooks.useIsomorphicLayoutEffect)(()=>{
        ...
        if (!u || (0, _platform.isRunningAcceptanceTest)(v) || !t) {
            h(!1);
            return;
        }
        const p = (0, _dom.getScrollableParentElement)(d.current), A = ()=>(0, _dom.hasScroll)(p) && (0, _dom.getScrollDistanceToBottom)(p) > a + 1, r = (0, _helpers.debounce)(()=>{
            h(A());
        }, 50, {
            leading: !0,
            maxWait: 100
        }), B = ne(r), c = ie(p);
        return (0, _dom.addPassiveEventListener)(c, "resize", r), (0, _dom.addPassiveEventListener)(c, "scroll", r), ()=>{
            r.cancel(), (0, _dom.removePassiveEventListener)(c, "scroll", r), (0, _dom.removePassiveEventListener)(c, "resize", r), B.cancel();
        };
    }, [
        v,
        u,
    ...
    const R = ()=>/* @__PURE__ */ (0, _jsxruntime.jsxs)(_portal.Portal, {
            ...
            children: [
                /* @__PURE__ */ (0, _jsxruntime.jsx)("div", {
                    ...
                    style: {
                        background: `linear-gradient(180deg, ${D} 50%, ${i} 50% 100%)`
                    }
                }),
                /* @__PURE__ */ (0, _jsxruntime.jsx)("div", {
                    ref: I,
        ...
        children: [
            /* @__PURE__ */ (0, _jsxruntime.jsxs)("div", {
                ...
                style: (0, _css.applyCssVars)({
                    [_fixedfooterlayoutcssmistica.vars.footerHeight]: t ? `${o}px` : "0px"
                }),
                children: [
                    R(),
                    L
