...
const V = /*#__PURE__*/ _react.lazy(()=>Promise.resolve().then(()=>/*#__PURE__*/ _interop_require_wildcard(require(/* webpackChunkName: "date-time-picker" */ "./date-time-picker.js")))), Y = (_param)=>{
    ...
    const k = (t)=>t, T = _react.useMemo(()=>(0, _dom.isInputTypeSupported)("month"), []), { texts: z, t: b } = (0, _hooks.useTheme)(), m = (t)=>!(r && t && t < (0, _time.getLocalYearMonthString)(r) || i && t && t > (0, _time.getLocalYearMonthString)(i)), u = (0, _formcontext.useFieldProps)({
        name: D,
        label: M,
        value: I,
        defaultValue: O,
        ...
        disabled: h,
        onBlur: y,
        validate: (t, a)=>m(t) ? n == null ? void 0 : n(t, a) : z.formDateOutOfRangeError || b(_texttokens.formDateOutOfRangeError),
        validateOnBlurInsideForm: R,
        onChange: S,
        onChangeValue: (t, a)=>{
            m(t) && (s == null || s(t, a));
        }
    }), p = /* @__PURE__ */ (0, _jsxruntime.jsx)(_textfieldbase.TextFieldBaseAutosuggest, _object_spread_props(_object_spread({}, l, u), {
        min: r ? (0, _time.getLocalYearMonthString)(r) : void 0,
    ...
    return T || (0, _environment.isServerSide)() ? p : /* @__PURE__ */ (0, _jsxruntime.jsx)(_react.Suspense, {
        fallback: p,
        children: /* @__PURE__ */ (0, _jsxruntime.jsx)(V, _object_spread_props(_object_spread({}, l, u), {
            optional: d,
