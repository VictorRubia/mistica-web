...
const v = (_param)=>{
    var { color: t, size: h = 24 } = _param, o = _object_without_properties(_param, [
        "color",
        "size"
    ]);
    const i = (0, _themevariantcontext.useIsInverseOrMediaVariant)(), l = t !== null && t !== void 0 ? t : i ? _skincontractcssmistica.vars.colors.inverse : _skincontractcssmistica.vars.colors.neutralHigh, { skinName: a } = (0, _hooks.useTheme)();
    return a.match(/^o2-new/i) ? /* @__PURE__ */ (0, _jsxruntime.jsx)("svg", _object_spread_props(_object_spread({
        width: h,
        height: h,
        viewBox: "0 0 24 24",
        role: "presentation"
        ...
        children: [
            ...
            /* @__PURE__ */ (0, _jsxruntime.jsx)("path", {
                fill: l,
                d: "M15.84 17.001a.768.768 0 1 0 .002 1.536A.768.768 0 0 0 15.84 17"
            })
        ]
    }));
}, d = v;
