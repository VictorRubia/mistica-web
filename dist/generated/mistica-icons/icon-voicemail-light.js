...
const m = (_param)=>{
    ...
    const t = (0, _themevariantcontext.useIsInverseOrMediaVariant)(), e = r !== null && r !== void 0 ? r : t ? _skincontractcssmistica.vars.colors.inverse : _skincontractcssmistica.vars.colors.neutralHigh, { skinName: s } = (0, _hooks.useTheme)();
    return s.match(/^o2-new/i) ? /* @__PURE__ */ (0, _jsxruntime.jsx)("svg", _object_spread_props(_object_spread({
        ...
        children: [
            ...
            /* @__PURE__ */ (0, _jsxruntime.jsx)("path", {
                fill: e,
                d: "M16.073 18.07a.716.716 0 1 1-1.431 0 .716.716 0 0 1 1.431 0"
            })
        ]
    }));
}, g = m;
