...
const v = (_param)=>{
    var { color: h, size: r = 24 } = _param, e = _object_without_properties(_param, [
        "color",
        "size"
    ]);
    const o = (0, _themevariantcontext.useIsInverseOrMediaVariant)(), c = h !== null && h !== void 0 ? h : o ? _skincontractcssmistica.vars.colors.inverse : _skincontractcssmistica.vars.colors.neutralHigh, { skinName: i } = (0, _hooks.useTheme)();
