...
const m = (_param)=>{
    ...
    const c = (0, _themevariantcontext.useIsInverseOrMediaVariant)(), a = h !== null && h !== void 0 ? h : c ? _skincontractcssmistica.vars.colors.inverse : _skincontractcssmistica.vars.colors.neutralHigh, { skinName: o } = (0, _hooks.useTheme)();
    ...
    })) : o.match(/^o2-new/i) ? /* @__PURE__ */ (0, _jsxruntime.jsxs)("svg", _object_spread_props(_object_spread({
        width: t,
        height: t,
        viewBox: "0 0 24 24",
        role: "presentation"
