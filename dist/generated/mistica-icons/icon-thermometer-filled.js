...
const m = (_param)=>{
    var { color: l, size: e = 24 } = _param, s = _object_without_properties(_param, [
        "color",
        "size"
    ]);
    const c = (0, _themevariantcontext.useIsInverseOrMediaVariant)(), r = l !== null && l !== void 0 ? l : c ? _skincontractcssmistica.vars.colors.inverse : _skincontractcssmistica.vars.colors.neutralHigh, { skinName: n } = (0, _hooks.useTheme)();
