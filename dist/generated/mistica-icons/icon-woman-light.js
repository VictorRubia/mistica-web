...
const s = (_param)=>{
    var { color: t, size: l = 24 } = _param, h = _object_without_properties(_param, [
        "color",
        "size"
    ]);
    const r = (0, _themevariantcontext.useIsInverseOrMediaVariant)(), o = t !== null && t !== void 0 ? t : r ? _skincontractcssmistica.vars.colors.inverse : _skincontractcssmistica.vars.colors.neutralHigh, { skinName: c } = (0, _hooks.useTheme)();
