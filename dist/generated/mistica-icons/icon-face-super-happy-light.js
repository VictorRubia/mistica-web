...
const m = (_param)=>{
    ...
    const h = (0, _themevariantcontext.useIsInverseOrMediaVariant)(), t = l !== null && l !== void 0 ? l : h ? _skincontractcssmistica.vars.colors.inverse : _skincontractcssmistica.vars.colors.neutralHigh, { skinName: c } = (0, _hooks.useTheme)();
    return c.match(/^vivo-new/i) ? /* @__PURE__ */ (0, _jsxruntime.jsx)("svg", _object_spread_props(_object_spread({
        width: e,
        height: e,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : c.match(/^o2-new/i) ? /* @__PURE__ */ (0, _jsxruntime.jsxs)("svg", _object_spread_props(_object_spread({
        width: e,
        height: e,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : c.match(/^o2/i) ? /* @__PURE__ */ (0, _jsxruntime.jsxs)("svg", _object_spread_props(_object_spread({
        width: e,
        height: e,
        viewBox: "0 0 24 24",
        role: "presentation"
        ...
        children: [
            ...
            /* @__PURE__ */ (0, _jsxruntime.jsx)("path", {
                fill: t,
                d: "M5.5 12.576A.57.57 0 0 1 6.071 12H17.82a.57.57 0 0 1 .571.587s-.085 2.933-2.316 4.705c-.949.754-2.285 1.308-4.18 1.318-1.898.009-3.228-.54-4.164-1.295-2.2-1.771-2.231-4.739-2.231-4.739m6.392 5.234c1.727-.01 2.887-.51 3.685-1.145.95-.753 1.458-1.768 1.73-2.63a7 7 0 0 0 .264-1.235H6.315q.007.075.018.17c.033.272.098.655.225 1.086.255.87.745 1.888 1.675 2.636.782.63 1.929 1.126 3.659 1.118"
            })
        ]
    }));
}, g = m;
