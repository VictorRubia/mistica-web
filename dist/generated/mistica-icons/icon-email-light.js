...
const m = (_param)=>{
    var { color: r, size: e = 24 } = _param, l = _object_without_properties(_param, [
        "color",
        "size"
    ]);
    const h = (0, _themevariantcontext.useIsInverseOrMediaVariant)(), i = r !== null && r !== void 0 ? r : h ? _skincontractcssmistica.vars.colors.inverse : _skincontractcssmistica.vars.colors.neutralHigh, { skinName: o } = (0, _hooks.useTheme)();
