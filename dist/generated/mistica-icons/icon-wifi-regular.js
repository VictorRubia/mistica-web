...
const f = (_param)=>{
    var { color: o, size: i = 24 } = _param, c = _object_without_properties(_param, [
        "color",
        "size"
    ]);
    const s = (0, _themevariantcontext.useIsInverseOrMediaVariant)(), a = o !== null && o !== void 0 ? o : s ? _skincontractcssmistica.vars.colors.inverse : _skincontractcssmistica.vars.colors.neutralHigh, { skinName: e } = (0, _hooks.useTheme)();
    return e.match(/^blau/i) ? /* @__PURE__ */ (0, _jsxruntime.jsxs)("svg", _object_spread_props(_object_spread({
        width: i,
        height: i,
        viewBox: "0 0 24 24",
        role: "presentation"
    ...
    })) : e.match(/^o2-new/i) ? /* @__PURE__ */ (0, _jsxruntime.jsxs)("svg", _object_spread_props(_object_spread({
        width: i,
        height: i,
        viewBox: "0 0 24 24",
        role: "presentation"
