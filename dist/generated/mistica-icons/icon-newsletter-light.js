...
const l = (_param)=>{
    var { color: s, size: h = 24 } = _param, r = _object_without_properties(_param, [
        "color",
        "size"
    ]);
    const v = (0, _themevariantcontext.useIsInverseOrMediaVariant)(), t = s !== null && s !== void 0 ? s : v ? _skincontractcssmistica.vars.colors.inverse : _skincontractcssmistica.vars.colors.neutralHigh, { skinName: i } = (0, _hooks.useTheme)();
