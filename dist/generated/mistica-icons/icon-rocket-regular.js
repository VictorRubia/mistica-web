...
const s = (_param)=>{
    var { color: t, size: a = 24 } = _param, l = _object_without_properties(_param, [
        "color",
        "size"
    ]);
    const m = (0, _themevariantcontext.useIsInverseOrMediaVariant)(), e = t !== null && t !== void 0 ? t : m ? _skincontractcssmistica.vars.colors.inverse : _skincontractcssmistica.vars.colors.neutralHigh, { skinName: o } = (0, _hooks.useTheme)();
