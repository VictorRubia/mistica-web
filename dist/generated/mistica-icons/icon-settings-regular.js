...
const s = (_param)=>{
    ...
    const i = (0, _themevariantcontext.useIsInverseOrMediaVariant)(), l = r !== null && r !== void 0 ? r : i ? _skincontractcssmistica.vars.colors.inverse : _skincontractcssmistica.vars.colors.neutralHigh, { skinName: t } = (0, _hooks.useTheme)();
    return t.match(/^o2-new/i) ? /* @__PURE__ */ (0, _jsxruntime.jsxs)("svg", _object_spread_props(_object_spread({
        ...
        children: [
            /* @__PURE__ */ (0, _jsxruntime.jsx)("path", {
                fill: l,
                d: "M12 17.716c-3 0-5.448-2.568-5.448-5.716S9 6.284 12 6.284 17.447 8.852 17.447 12 14.999 17.716 12 17.716m0-10c-2.253 0-4.083 1.92-4.083 4.284s1.83 4.284 4.082 4.284c2.253 0 4.083-1.92 4.083-4.284s-1.83-4.284-4.083-4.284"
            }),
            /* @__PURE__ */ (0, _jsxruntime.jsx)("path", {
                fill: l,
    ...
    })) : t.match(/^o2/i) ? /* @__PURE__ */ (0, _jsxruntime.jsxs)("svg", _object_spread_props(_object_spread({
        width: a,
        height: a,
        viewBox: "0 0 24 24",
        role: "presentation"
