...
const v = (_param)=>{
    var { color: l, size: h = 24 } = _param, t = _object_without_properties(_param, [
        "color",
        "size"
    ]);
    const r = (0, _themevariantcontext.useIsInverseOrMediaVariant)(), e = l !== null && l !== void 0 ? l : r ? _skincontractcssmistica.vars.colors.inverse : _skincontractcssmistica.vars.colors.neutralHigh, { skinName: a } = (0, _hooks.useTheme)();
