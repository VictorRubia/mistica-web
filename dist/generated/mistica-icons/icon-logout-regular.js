...
const s = (_param)=>{
    var { color: r, size: e = 24 } = _param, h = _object_without_properties(_param, [
        "color",
        "size"
    ]);
    const c = (0, _themevariantcontext.useIsInverseOrMediaVariant)(), a = r !== null && r !== void 0 ? r : c ? _skincontractcssmistica.vars.colors.inverse : _skincontractcssmistica.vars.colors.neutralHigh, { skinName: o } = (0, _hooks.useTheme)();
