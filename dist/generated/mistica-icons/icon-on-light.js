...
const l = (_param)=>{
    var { color: t, size: s = 24 } = _param, e = _object_without_properties(_param, [
        "color",
        "size"
    ]);
    const h = (0, _themevariantcontext.useIsInverseOrMediaVariant)(), c = t !== null && t !== void 0 ? t : h ? _skincontractcssmistica.vars.colors.inverse : _skincontractcssmistica.vars.colors.neutralHigh;
