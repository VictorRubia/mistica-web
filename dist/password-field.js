...
const O = (param)=>{
    ...
    return /* @__PURE__ */ (0, _jsxruntime.jsx)(_textfieldbase.FieldEndIcon, {
        checkedProps: {
            Icon: _iconeyeoffregular.default,
            "aria-label": t.disablePasswordVisibility || s(_texttokens.disablePasswordVisibility)
        },
        uncheckedProps: {
            Icon: _iconeyeregular.default,
            "aria-label": t.enablePasswordVisibility || s(_texttokens.enablePasswordVisibility)
        },
        checked: n,
        onChange: (l)=>{
            a(l), c();
    ...
    const [u, g] = _react.useState(!1), o = _react.useRef(0), r = _react.useRef(null), h = (e)=>e, x = ()=>{
        const e = r.current;
    ...
    return /* @__PURE__ */ (0, _jsxruntime.jsx)(_textfieldbase.TextFieldBaseAutosuggest, _object_spread_props(_object_spread({}, V, f), {
        type: u ? "text" : "password",
        inputRef: (e)=>{
            f.inputRef(e), r.current = e;
        },
        autoComplete: R,
        endIcon: /* @__PURE__ */ (0, _jsxruntime.jsx)(O, {
            focus: x,
            isVisible: u,
            setVisibility: g
        }),
