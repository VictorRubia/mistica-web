...
export type AlwaysTouchableComponentProps = ExclusifyUnion<OnPressProps | HrefProps | ToProps> & Pick<CommonProps, 'trackingEvent' | 'dataAttributes' | 'role' | 'aria-label' | 'aria-labelledby' | 'aria-description' | 'aria-describedby' | 'aria-current'>;
export type TouchableComponentProps<Props> = ExclusifyUnion<Props | (OnPressProps & Props) | (HrefProps & Props) | (ToProps & Props)> & Pick<CommonProps, 'trackingEvent' | 'dataAttributes' | 'role' | 'aria-label' | 'aria-labelledby' | 'aria-description' | 'aria-describedby' | 'aria-current'>;
