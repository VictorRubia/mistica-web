export declare const TRANSITION_TIME_IN_MS = 300;
export declare const snackbar: string;
export declare const snackbarContainer: string;
export declare const snackbarOpen: string;
