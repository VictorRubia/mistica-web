...
const K = (i, t, r, c)=>{
...
}, M = /*#__PURE__*/ _react.forwardRef((_param, b)=>{
    ...
    const e = _react.useRef(null), h = (o)=>o, y = (o)=>{
    ...
    }, l = (0, _formcontext.useFieldProps)({
        name: c,
        label: m,
        value: R,
        defaultValue: F,
    ...
    return K(e.current, l.value, s.maxLength, l.onChange), /* @__PURE__ */ (0, _jsxruntime.jsx)(_textfieldbase.TextFieldBaseAutosuggest, _object_spread_props(_object_spread({}, s, l), {
        onClick: g,
        inputRef: (0, _common.combineRefs)(e, l.inputRef, b),
        onFocus: A,
        type: "text",
